...
/**
 * Generated class for the UserSendquotationPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-user-sendquotation',
  templateUrl: 'user-sendquotation.html',
})
export class UserSendquotationPage {
